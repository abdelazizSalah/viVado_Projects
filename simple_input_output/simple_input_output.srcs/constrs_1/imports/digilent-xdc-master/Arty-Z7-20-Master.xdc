...
## Switches
set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { i }]; #IO_L7N_T1_AD2N_35 Sch=SW0
...
## LEDs
set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { o }]; #IO_L6N_T0_VREF_34 Sch=LED0
