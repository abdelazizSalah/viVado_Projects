...
#
# Script generated by Vivado on Sun Mar 30 12:15:51 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_mem_gen_sk1.sh
...
#
# Usage        : blk_mem_gen_sk1.sh
#                blk_mem_gen_sk1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_sk1.sh [-reset_run]
#                blk_mem_gen_sk1.sh [-reset_log]
#                blk_mem_gen_sk1.sh [-help]
#
...
# script info
echo -e "blk_mem_gen_sk1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_sk1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_sk1 xil_defaultlib.blk_mem_gen_sk1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_sk1 -key {Behavioral:sim_1:Functional:blk_mem_gen_sk1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_mem_gen_sk1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_gen_sk1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_gen_sk1.sh [-help]\n\
Usage: blk_mem_gen_sk1.sh [-step]\n\
Usage: blk_mem_gen_sk1.sh [-lib_map_path]\n\
Usage: blk_mem_gen_sk1.sh [-reset_run]\n\
Usage: blk_mem_gen_sk1.sh [-reset_log]\n\
Usage: blk_mem_gen_sk1.sh [-keep_index]\n\
Usage: blk_mem_gen_sk1.sh [-noclean_files]\n\n\
