...
HD_PWD='E:/GitHub/viVado_Projects/Bike/Bike.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_BIKE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TB_BIKE.tcl -notrace
