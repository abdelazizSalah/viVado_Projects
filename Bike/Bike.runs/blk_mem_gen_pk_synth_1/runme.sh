...
HD_PWD='E:/GitHub/viVado_Projects/Bike/Bike.runs/blk_mem_gen_pk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_pk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_pk.tcl
