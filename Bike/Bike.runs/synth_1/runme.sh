...
HD_PWD='E:/GitHub/viVado_Projects/Bike/Bike.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_BIKE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TB_BIKE.tcl
