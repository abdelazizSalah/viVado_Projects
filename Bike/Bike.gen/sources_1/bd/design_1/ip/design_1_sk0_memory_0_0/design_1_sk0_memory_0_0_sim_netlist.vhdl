...
--               e:/GitHub/viVado_Projects/Bike/Bike.gen/sources_1/bd/design_1/ip/design_1_sk0_memory_0_0/design_1_sk0_memory_0_0_sim_netlist.vhdl
...
entity design_1_sk0_memory_0_0_sk0_memory is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_sk0_memory_0_0_sk0_memory : entity is "sk0_memory";
end design_1_sk0_memory_0_0_sk0_memory;

architecture STRUCTURE of design_1_sk0_memory_0_0_sk0_memory is
  ...
  attribute SOFT_HLUTNM of \counter_rep[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter_rep[1]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \memoOut[10]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \memoOut[11]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \memoOut[12]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \memoOut[13]_INST_0\ : label is "soft_lutpair3";
begin
...
\counter_rep[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\counter_rep[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\memoOut[0]_INST_0\: unisim.vcomponents.MUXF7
     port map (
      I0 => g0_b0_n_0,
      I1 => g1_b0_n_0,
      O => memoOut(0),
...
\memoOut[4]_INST_0\: unisim.vcomponents.MUXF7
     port map (
      I0 => g0_b4_n_0,
      I1 => g1_b4_n_0,
      O => memoOut(4),
...
\memoOut[6]_INST_0\: unisim.vcomponents.MUXF7
     port map (
      I0 => g0_b6_n_0,
      I1 => g1_b6_n_0,
      O => memoOut(6),
...
entity design_1_sk0_memory_0_0 is
  ...
  attribute NotValidForBitStream of design_1_sk0_memory_0_0 : entity is true;
  ...
  attribute X_CORE_INFO of design_1_sk0_memory_0_0 : entity is "sk0_memory,Vivado 2024.2";
end design_1_sk0_memory_0_0;

architecture STRUCTURE of design_1_sk0_memory_0_0 is
...
begin
inst: entity work.design_1_sk0_memory_0_0_sk0_memory
     port map (
      clk => clk,
