...
## Switches
set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { btn }]; #IO_L7N_T1_AD2N_35 Sch=SW0
set_property -dict { PACKAGE_PIN M19    IOSTANDARD LVCMOS33 } [get_ports { btn2 }]; #IO_L7P_T1_AD2P_35 Sch=SW1
...
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { clock_out }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
